...
export const moduleCatalog: ModuleDefinition[] = [
  ...
  { id: "osint.rdap-domain", name: "RDAP domain", group: "intelligence", description: "Metadata registrasi domain dari layanan RDAP publik.", input: "Domain dalam allowlist", output: "Registrar, status, tanggal, nameserver", active: false, previewOnly: true, manualValidationRequired: true, safetyNote: "Metadata publik saja; tanpa data pribadi berlebihan." },
  ...
  { id: "osint.ct-inventory", name: "Certificate Transparency", group: "intelligence", description: "Inventaris nama host dari log sertifikat publik.", input: "Domain dalam allowlist", output: "SAN/hostname unik dan waktu terlihat", active: false, previewOnly: true, manualValidationRequired: true, safetyNote: "Kandidat wajib diverifikasi dan tetap tunduk scope." },
  ...
  { id: "osint.robots-sitemap", name: "Robots dan sitemap", group: "intelligence", description: "Membaca metadata robots.txt dan sitemap secara terbatas.", input: "URL dalam allowlist", output: "Path publik dan aturan crawler", active: false, previewOnly: true, manualValidationRequired: true, safetyNote: "Tidak crawling path secara otomatis." },
  { id: "osint.favicon-hash", name: "Favicon hash", group: "intelligence", description: "Hash favicon untuk korelasi aset publik.", input: "URL favicon publik", output: "Hash dan relasi aset", active: false, previewOnly: true, manualValidationRequired: true, safetyNote: "Ukuran respons dibatasi dan bytes tidak disimpan." },
  ...
  { id: "osint.email-security", name: "SPF/DKIM/DMARC", group: "intelligence", description: "Penilaian konfigurasi keamanan email melalui DNS publik.", input: "Domain dalam allowlist", output: "Record dan rekomendasi", active: false, previewOnly: true, manualValidationRequired: true, safetyNote: "Tidak mengirim email atau menguji akun." },
  { id: "osint.mx-infrastructure", name: "Infrastruktur MX", group: "intelligence", description: "Metadata provider MX dan redundansi email.", input: "Domain dalam allowlist", output: "Host MX, prioritas, provider indikatif", active: false, previewOnly: true, manualValidationRequired: true, safetyNote: "DNS lookup terbatas dan rate-limited." },
  { id: "osint.nameserver-infrastructure", name: "Infrastruktur nameserver", group: "intelligence", description: "Analisis nameserver, provider, dan konsistensi record.", input: "Domain dalam allowlist", output: "NS, IP, provider indikatif", active: false, previewOnly: true, manualValidationRequired: true, safetyNote: "Tidak melakukan zone transfer." },
  ...
  { id: "osint.redirect-chain", name: "Rantai redirect HEAD", group: "intelligence", description: "Ringkasan redirect terbatas dengan metode HEAD.", input: "URL dalam allowlist", output: "Status dan host per hop", active: false, previewOnly: true, manualValidationRequired: true, safetyNote: "Hop, timeout, dan host dibatasi." },
  { id: "osint.archive-metadata", name: "Metadata arsip web", group: "intelligence", description: "Indeks URL publik dari layanan arsip yang disetujui.", input: "Domain dalam allowlist", output: "URL, timestamp, tipe konten", active: false, previewOnly: true, manualValidationRequired: true, safetyNote: "Tidak mengambil isi arsip secara massal." },
